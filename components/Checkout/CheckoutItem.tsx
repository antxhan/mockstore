...
export default function CheckoutItem({ item }: { item: CartItem }) {
  return (
    <div className="flex items-center gap-2">
      <div className="aspect-square max-h-16 min-h-16 max-w-16 min-w-16 overflow-hidden rounded-lg border border-neutral-300 bg-neutral-000 p-1">
        <Image
          src={item.image}
          alt={item.title}
          width={100}
      ...
      <div className="flex max-w-[15ch] flex-col gap-1 overflow-hidden text-small">
